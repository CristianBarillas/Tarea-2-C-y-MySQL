...
#include <mysql.h>
	...
	private: int id_tipo_sangre, id_estudiante;
	...
	public:
		...
		void setidtiposangre(int sangre) {
			id_tipo_sangre = sangre;
		}
		void setid_estudiante(int estudiante) {
			id_estudiante = estudiante;
		}
		...
		void actualizar() {
			...
			if (cn.getConectar()) {
				string  actualizar =
					"update estudiantes set codigo =" + c + ", nombres='" + nombres + "', apellidos = '" + apellidos + "', direccion = '" + direccion + "', telefono =" + t + ", fecha_nacimiento='" + fecha_nacimiento + "', id_tipo_sangre= '" + s + "' where id_estudiante = " + ii + "";
		...
		void borrar() {
			...
			if (cn.getConectar()) {
				string  borrar =
					"delete from estudiantes  where id_estudiante= " + p + "";
